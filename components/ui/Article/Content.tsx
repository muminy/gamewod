...
export default function ArticleContent(article: ArticleProps) {
  ...
  return (
    <div className="content-wrapper">
      ...
      <div className="xl:col-span-6 lg:col-span-8 md:col-span-8 col-span-12 xl:px-40 lg:px-14 px-0">
        <News.Header
      ...
      <div className="xl:col-span-3 lg:col-span-4 md:col-span-4 col-span-12 flex flex-col"></div>
    </div>
  );
}
